...
<body background="Background/a9.bmp">
    ...
    <div>
            ...
            <table cellpadding="0" style="width: 100%; position: static; border-bottom: gray 1px solid;" border="0" cellspacing="0">
                ...
                <tr>
                    <td align="right" colspan="2" valign="top" style="height: 13px">
                        ...
                        <asp:Label ID="Label3" runat="server" Style="position: static" Text="Campus & Space  for every one" Font-Size="10pt" Width="260px" Font-Bold="True" ForeColor="Gainsboro"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 100px; height: 13px">
                    ...
                    <asp:TextBox ID="TextBox3" runat="server" OnTextChanged="TextBox3_TextChanged" Style="position: static" Font-Bold="True" Font-Names="Arial" Font-Size="8pt" Width="150px" ForeColor="MidnightBlue">aaaaaaaa</asp:TextBox></td>
                                    <td style="width: 100px" align="right">
                ...
                <tr>
                    <td align="left" rowspan="2" style="width: 171px; height: 217px;" valign="top">
                        <div style="text-align: left">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 433px; position: static">
                                ...
                                Style="position: static" Text="web2nd connect every person, every machin to the world........" Width="348px" Font-Names="Arial"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td style="width: 100px" valign="top">
                                    </td>
                    ...
                    <td align="right" rowspan="2" style="width: 144px; height: 217px;" valign="top">
                        <div style="text-align: left">
                            <table border="0" cellpadding="0" cellspacing="0" style="position: static">
                                <tr>
                                    <td style="width: 100px">
                                        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/HomePage.jpg" Style="position: static" /></td>
                                </tr>
                                <tr>
                                    <td style="width: 100px">
                                        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click1" Style="position: static"
                        Text="New User Signup" Font-Bold="True" Font-Names="Arial Baltic" Font-Size="9pt" ValidationGroup="A1" Width="126px" BackColor="OliveDrab" BorderWidth="1px" ForeColor="White" BorderColor="#404040" Height="21px" Visible="False" /></td>
                                </tr>
                                <tr>
                                    <td style="width: 100px">
                                        <br />
                        <asp:Panel ID="Panel1" runat="server" Height="50px" Style="position: static" Visible="False"
                            ...
                            <table cellpadding="0" style="position: static; font-weight: bold; text-align: left;" cellspacing="8" width="380">
                                ...
                                <tr>
                                    <td align="left" colspan="3" style="height: 1px" valign="top">
                                        </td>
                                </tr>
                                <tr>
                                    <td style="width: 31px; height: 9px;" align="right" valign="top">
                                        <asp:Label ID="Label5" runat="server" Style="position: static"
                        Text="First Name" Font-Bold="False" Font-Names="Arial" Font-Size="10pt" ForeColor="MidnightBlue" Width="100px"></asp:Label></td><td style="width: 39px; height: 9px;" valign="top">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox5"
                                ErrorMessage="First Name Req." ForeColor="Navy" Style="position: static" ValidationGroup="A1">*</asp:RequiredFieldValidator></td>
                                    <td style="width: 100px; height: 9px;" align="left" valign="top">
                    ...
                    <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Style="position: static"
                        Text="Signup" Font-Bold="True" Font-Names="Arial Baltic" Font-Size="9pt" ValidationGroup="A1" Width="85px" BackColor="OliveDrab" BorderWidth="1px" ForeColor="Black" BorderColor="#404040" Height="21px" /></td>
                                </tr>
                                <tr>
                ...
                <tr>
                    <td align="right" colspan="2" style="height: 39px" valign="top">
                        ...
                        <br />
                        &nbsp;&nbsp;
                            <asp:Label ID="Label15" runat="server" Font-Bold="True" Font-Size="9pt" ForeColor="DarkBlue"
                                Style="position: static" Width="218px"></asp:Label>
                        <asp:LinkButton ID="LinkButton2" runat="server" Font-Underline="False" ForeColor="MidnightBlue"
                            OnClick="LinkButton2_Click" Style="position: static" Width="521px" Font-Size="11pt" Font-Bold="True" Height="20px">Create a Educational Network System for your College and Institute.</asp:LinkButton><asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Style="position: static"
                        Text="Signup now" Font-Bold="True" Font-Names="Arial Baltic" Font-Size="9pt" ValidationGroup="A1" Width="85px" BackColor="OliveDrab" BorderWidth="1px" ForeColor="Black" BorderColor="#404040" Height="21px" /></td>
                </tr>
                <tr>
        ...
        <asp:Label ID="Label10" runat="server" Font-Bold="True" ForeColor="DarkOliveGreen"
                            Style="position: static" Width="193px" Font-Size="9pt"></asp:Label>
        <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Size="9pt" ForeColor="DarkBlue"
            Style="position: static" Text="© MauCom Solutions (P) Ltd" Width="218px"></asp:Label><br />
        &nbsp;&nbsp;
