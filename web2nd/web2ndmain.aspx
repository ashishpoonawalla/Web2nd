<%@ Page Language="C#" MasterPageFile="~/web2nd/main.master" AutoEventWireup="true" CodeFile="web2ndmain.aspx.cs" Inherits="web2nd_wbb2ndmain" Title="News Feed - web2nd"  %>

<%@ Register Src="../Footer1.ascx" TagName="Footer1" TagPrefix="uc1" %>
...
</asp:SqlDataSource></TD><TD style="WIDTH: 100px; HEIGHT: 16px; BACKGROUND-COLOR: white"><asp:LinkButton style="POSITION: static" id="LinkButton1" onclick="LinkButton1_Click1" runat="server" Width="80px" Visible="False">Top updates</asp:LinkButton></TD><TD style="WIDTH: 100px; HEIGHT: 16px; BACKGROUND-COLOR: white"><asp:LinkButton style="POSITION: static" id="LinkButton8" onclick="LinkButton8_Click" runat="server" Width="80px" Visible="False">Recent updates</asp:LinkButton></TD><TD style="WIDTH: 100px; HEIGHT: 16px; BACKGROUND-COLOR: white"><asp:LinkButton style="POSITION: static" id="LinkButton3" onclick="LinkButton3_Click1" runat="server" Width="80px">My Updates</asp:LinkButton></TD></TR></TBODY></TABLE></DIV><asp:DataList accessKey="c" style="POSITION: static" id="DataList3" runat="server" Width="588px" OnSelectedIndexChanged="DataList3_SelectedIndexChanged" DataSourceID="SqlDataSource3" DataKeyField="id"><ItemTemplate>
<DIV style="TEXT-ALIGN: left"><TABLE style="BORDER-TOP: gainsboro 1px solid; WIDTH: 571px; POSITION: static" cellSpacing=0 cellPadding=0 border=0><TBODY><TR><TD style="WIDTH: 100px; HEIGHT: 63px" vAlign=top rowSpan=3><asp:ImageButton style="POSITION: static" id="ImageButton1" onclick="ImageButton1_Click" runat="server" Width="50px" Height="50px" BorderStyle="Solid" BorderColor="White" BorderWidth="8px" ImageUrl='<%# Eval("S_Photo") %>' CommandName="Select" __designer:wfdid="w47"></asp:ImageButton> <asp:Label style="POSITION: static" id="Label7" runat="server" Visible="False" Text='<%# Eval("id") %>' Font-Size="7pt" __designer:wfdid="w48"></asp:Label> </TD><TD style="WIDTH: 100px; HEIGHT: 63px" vAlign=top rowSpan=3><asp:Label style="POSITION: static" id="Message1Label" runat="server" Width="495px" Height="19px" Text='<%# Eval("Message1") %>' ForeColor="#365156" BorderStyle="Solid" BorderColor="White" BorderWidth="4px" Font-Size="9pt" __designer:wfdid="w49"></asp:Label><BR /><DIV style="TEXT-ALIGN: left"><asp:HyperLink style="POSITION: static" id="HyperLink1" runat="server" Width="492px" Text='<%# Eval("URL1") %>' BorderStyle="Solid" BorderColor="White" BorderWidth="4px" NavigateUrl='<%# Eval("URL1") %>' Target="_blank" __designer:wfdid="w50"></asp:HyperLink><BR /><asp:ImageButton style="POSITION: static" id="ImageButton6" onclick="ImageButton6_Click" runat="server" ImageUrl='<%# Eval("pic1") %>' CommandName="Select" __designer:wfdid="w51"></asp:ImageButton><BR /><TABLE style="WIDTH: 300px; POSITION: static" cellSpacing=2 cellPadding=2 border=0><TBODY><TR><TD vAlign=bottom><asp:LinkButton style="POSITION: static" id="LinkButton5" onclick="LinkButton5_Click" runat="server" Width="29px" Font-Size="8pt" CommandName="Select" __designer:wfdid="w52">Like</asp:LinkButton></TD><TD style="WIDTH: 472px" vAlign=bottom><asp:LinkButton style="POSITION: static" id="LinkButton7" onclick="LinkButton7_Click" runat="server" Width="101px" Font-Size="8pt" CommandName="Select" __designer:wfdid="w53">Comment</asp:LinkButton></TD><TD style="WIDTH: 472px" vAlign=bottom><asp:LinkButton style="POSITION: static" id="LinkButton4" onclick="LinkButton4_Click1" runat="server" Width="40px" Text='<%# Eval("Date1") %>' ForeColor="Gray" Font-Size="8pt" CommandName="Select" __designer:wfdid="w54"></asp:LinkButton></TD><TD style="WIDTH: 143px" vAlign=bottom><asp:Label style="POSITION: static" id="Label6" runat="server" Width="90px" Text='<%# Eval("Time1") %>' ForeColor="Gray" Font-Size="8pt" __designer:wfdid="w55"></asp:Label></TD><TD style="WIDTH: 100px" vAlign=bottom><asp:LinkButton style="POSITION: static" id="LinkButton6" onclick="LinkButton6_Click" runat="server" Width="40px" ForeColor="LightCoral" Font-Size="8pt" CommandName="Select" __designer:wfdid="w56">Share</asp:LinkButton></TD><TD style="WIDTH: 142px" vAlign=bottom><asp:LinkButton style="POSITION: static" id="LinkButton2" onclick="LinkButton2_Click" runat="server" Width="80px" ForeColor="DarkSeaGreen" CommandName="Select" __designer:wfdid="w57">Detail</asp:LinkButton></TD><TD style="WIDTH: 100px" vAlign=bottom><asp:ImageButton style="POSITION: static" id="ImageButton12" onclick="ImageButton12_Click" runat="server" Width="16px" Height="16px" ImageUrl='<%# Eval("Type") %>' __designer:wfdid="w58"></asp:ImageButton></TD><TD style="WIDTH: 100px" vAlign=bottom><asp:ImageButton style="POSITION: static" id="ImageButton7" onclick="ImageButton14_Click" runat="server" Visible="False" ImageUrl="~/images/ToolClose.bmp" CommandName="Select" __designer:wfdid="w59"></asp:ImageButton></TD></TR></TBODY></TABLE></DIV></TD></TR><TR></TR><TR></TR><TR><TD style="WIDTH: 100px" vAlign=top></TD><TD style="WIDTH: 100px" vAlign=top><asp:SqlDataSource id="SqlDataSource4" runat="server" UpdateCommand="UPDATE [MessageReply] SET [MID] = @MID, [R_Email] = @R_Email, [R_Photo] = @R_Photo, [Message1] = @Message1, [Date1] = @Date1, [Time1] = @Time1, [DateTime1] = @DateTime1 WHERE [id] = @id" InsertCommand="INSERT INTO [MessageReply] ([MID], [R_Email], [R_Photo], [Message1], [Date1], [Time1], [DateTime1]) VALUES (@MID, @R_Email, @R_Photo, @Message1, @Date1, @Time1, @DateTime1)" DeleteCommand="DELETE FROM [MessageReply] WHERE [id] = @id" SelectCommand="SELECT id, MID, R_Email, R_Photo, Message1, Date1, Time1, DateTime1 FROM MessageReply WHERE (MID = @MID) ORDER BY DateTime1 DESC" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" __designer:wfdid="w60"><SelectParameters>
...
</asp:SqlDataSource><asp:GridView style="POSITION: static" id="GridView1" runat="server" Width="406px" ForeColor="#404040" BorderStyle="None" BorderColor="White" BorderWidth="0px" BackColor="Lavender" DataSourceID="SqlDataSource4" AutoGenerateColumns="False" PageSize="6" GridLines="None" AllowPaging="True" CellSpacing="3" __designer:wfdid="w61"><Columns>
